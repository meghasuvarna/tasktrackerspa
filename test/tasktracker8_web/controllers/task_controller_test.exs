defmodule Tasktracker8Web.TaskControllerTest do
  use Tasktracker8Web.ConnCase

  alias Tasktracker8.Tasks
  alias Tasktracker8.Tasks.Task

  @create_attrs %{completed: true, description: "some description", timetaken: 42, title: "some title"}
